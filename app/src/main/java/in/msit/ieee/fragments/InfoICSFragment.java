...
public class InfoICSFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.info_content_ics, container, false);
    ...
    @OnClick(R.id.gmail1)
    public void gmail1() {
        openGmail("yatingupta12@gmail.com");
    }

    @OnClick(R.id.fb1)
    public void fb1() {
        openFaceBook("https://www.facebook.com/yatingupta1996");
    }

    @OnClick(R.id.in1)
    public void in1() {
        openLinkedIn("https://www.linkedin.com/in/yatingupta12");
    }
    ...
    @OnClick(R.id.gmail3)
    public void gmail3() {
        openGmail("abhijeet_chauhan@icloud.com");
    }
    ...
    @OnClick(R.id.in3)
    public void in3() {
        openLinkedIn("https://www.linkedin.com/in/chauhanabhijeet/");
    }


    @OnClick(R.id.gmail4)
    public void gmail4() {
        openGmail("sahil_khurana@outlook.com");
    }

    @OnClick(R.id.fb4)
    public void fb4() {
        openFaceBook("https://www.facebook.com/Sahil.khurana19");
    }

    @OnClick(R.id.in4)
    public void in4() {
        openLinkedIn("https://www.linkedin.com/in/sahilkhurana19/");
    }
    ...
    private void setData() {
        ...
        a5h.setText(Html.fromHtml(getString(R.string.a5cs)));
        a6h.setText(Html.fromHtml(getString(R.string.a6cs)));
        a7h.setText(Html.fromHtml(getString(R.string.a7cs)));
        q8h.setText(getString(R.string.q8, "CS"));
    }
