...
public class InfoMTTSFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.info_content_mtts, container, false);
    ...
    @OnClick(R.id.gmail1)
    public void gmail1() {
        openGmail("amanguptamsit@gmail.com");
    }
    ...
    @OnClick(R.id.gmail2)
    public void gmail2() {
        openGmail("varun.goel.in@ieee.org");
    }
    ...
    @OnClick(R.id.gmail3)
    public void gmail3() {
        openGmail("rashikaagg19@gmail.com");
    }

    @OnClick(R.id.fb3)
    public void fb3() {
        openFaceBook("https://www.facebook.com/rashika.aggarwal.3");
    }

    @OnClick(R.id.in3)
    public void in3() {
        openLinkedIn("https://www.linkedin.com/in/rashika-aggarwal-7a423b10a");
    }


    @OnClick(R.id.gmail4)
    public void gmail4() {
        openGmail("utkarsh@ieee.org");
    }
    ...
    @OnClick(R.id.gmail5)
    public void gmail5() {
        openGmail("ujjwalsinghmsit01@gmail.com");
    }

    @OnClick(R.id.fb5)
    public void fb5() {
        openFaceBook("https://www.facebook.com/ujjwal.singh.988711?ref=br_rs");
    }

    @OnClick(R.id.in5)
    public void in5() {
        openLinkedIn("https://linkedin.com/in/ujjwal-singh-285b42110");
    }
    ...
    private void setData() {
        q1h.setText(getString(R.string.q1, "MTTS"));
        a1h.setText(Html.fromHtml(getString(R.string.a1mtts)));

        q2h.setText(getString(R.string.q2, "MTTS"));
        a2h.setText(Html.fromHtml(getString(R.string.a2mtts)));

        q3h.setText(getString(R.string.q3, "MTTS"));
  //      a3h.setText(Html.fromHtml(getString(R.string.a3mtts)));
        a3h.setMovementMethod(LinkMovementMethod.getInstance());
        a5h.setText(Html.fromHtml(getString(R.string.a5mtts)));
        a7h.setText(Html.fromHtml(getString(R.string.a7mtts)));
        q8h.setText(getString(R.string.q8, "MTTS"));
    }
